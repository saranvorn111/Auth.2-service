...
import com.developerscambodia.oauth2server.domain.entity.Authorization;
...
import com.developerscambodia.oauth2server.security.jackson.AuthorityMixIn;
import com.developerscambodia.oauth2server.security.jackson.CustomerUserDetailsMixIn2;
import com.developerscambodia.oauth2server.security.jackson.HashSetMixin;
import com.developerscambodia.oauth2server.security.jackson.UserMixIn;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        ...
        System.out.println("FUCK => " + tokenType.getValue());
    ...
    private OAuth2Authorization toObject(Authorization entity) {
        ...
        System.out.println("ERROR KANGCHI => " + entity.getAttributes());
        ...
        if (entity.getAccessTokenValue() != null) {
            ...
            System.out.println("ERROR KANGCHI => " + entity.getAccessTokenMetadata());
        ...
        if (entity.getRefreshTokenValue() != null) {
            ...
            System.out.println("ERROR KANGCHI => " + entity.getRefreshTokenMetadata());
    ...
    private Map<String, Object> parseMap(String data) {
        try {
            System.out.println("ERROR KANGCHI => " + data);
    ...
    private static AuthorizationGrantType resolveAuthorizationGrantType(String authorizationGrantType) {
        ...
        System.out.println("resolveAuthorizationGrantType => " + authorizationGrantType);
